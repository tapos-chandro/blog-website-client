      ...
      {loading ? (
        ...
        <Box>
          ...
          >
            ...
            <Input placeholder="Search" rounded="full" textColor={"gray"} _focus={{border:"none"}} name="search" onChange={(e) => {setSearch(e.target.value)}} border={"1px"} borderColor={"primary"} maxW={"2xl"} />
